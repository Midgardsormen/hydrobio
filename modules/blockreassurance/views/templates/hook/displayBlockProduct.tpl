...
<div class="blockreassurance_product container">
    <div class="row">
        {foreach from=$blocks item=$block key=$key}
            <div{if $block['type_link'] !== $LINK_TYPE_NONE && !empty($block['link'])} style="cursor:pointer;" onclick="window.open('{$block['link']}')"{/if} class="blockreassurance_product--item">
